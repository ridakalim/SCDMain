...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:white"></i>		
  ...
  <ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
    ...
    <li class="nav-item">
      <a class="btn btn-dark btn1" onclick="comp()" href="#">Submission</a>
    </li>
	 <li class="nav-item" style="display:none;" id="m_comp">
      <a class="btn btn-dark btn1" onclick="makecomplaint()" href="#">Make Submission</a>
    </li>
    ...
    <li class="nav-item" >
      <a class="btn btn-dark btn1" onclick="inpro()" style="display:none;" id="i_comp" href="#">Processing</a>
    </li>
    <li class="nav-item" >
      <a class="btn btn-dark btn1" onclick="pending()" style="display:none;" id="p_comp" href="#">Pending</a>
    </li>
	<li class="nav-item" >
      <a class="btn btn-dark btn1" onclick="history()" style="display:none;" id="h_comp" href="#">Submission history</a>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<h4>>Dashboard<hr /></h4>
				<div id="file1" onclick="pending()" style="cursor:pointer;">
					...
					<p id="file12" style="display:block;font-size:15px;text-align:center;">Pending Submission<div id="pen"><?php echo $pend; ?></div></p>
				</div>
					<div id="file2" onclick="inpro()" style="cursor:pointer;">
						<i class="fa fa-file-text" style=""></i>
						<p id="file22" style="display:block;font-size:15px;text-align:center;">Processing SUbmission<div id="pen2"><?php echo $inpro; ?></div></p>
					</div>
						<div id="file3" onclick="completed()" style="cursor:pointer;">
							<i class="fa fa-file-text" style=""></i>
							<p id="file32" style="display:block;font-size:15px;text-align:center;">Completed SUbmission<div id="pen3"><?php echo $compl; ?></div></p>
						</div>
			</div>
			...
			<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				...
				<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
					...
					<select id="category" name="category" style="width:30%;border-radius:12px;height:37px;"> 
						<option>Other</option>
						<option>Bus Point Service</option>
						
					</select>
					<span id="span2" style="margin-left:20px;">Amount</span>
					...
					<br /><br />
					<span id="span2">Account Name/ Bank Name</span><input type="text" name="nature" class="form-control in2" placeholder="Account Name or Bank Name"><br />
					<span id="span">Detail</span>
					<textarea name="comp" class="form-control in1" placeholder="Month of Submission or Relevent Detail" style="height:200px;"></textarea><br />
	...
	if($num==0)
	{
		echo "Still there is no record";
			...
			<div class="" id="inpro" style="width:90%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				<h4>>Inprogress Submissions<hr /></h4>
				<?php
				$num=0;
				$query1="SELECT * FROM `complaints`";
	...
	if($num==0)
	{
		echo "Still there is no record";
			...
			<div class="" id="completed" style="width:90%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				<h4>>Completed Submissions<hr /></h4>
				<?php
				$num=0;
				$query1="SELECT * FROM `complaints`";
