...
<html>
  ...
  <title>Admin</title>
	...
	<body>
		...
		<div class="container">
		<h2 style="padding-top:10px;">Complete the processing submissions here</h2><hr />
			...
			<h5>USER NAME
				...
				<textarea type="text" name="remark" class="form-control" style="height:200px" placeholder="Enter Remark here to approve this submission."></textarea>
				<input type="submit" value="Complete" class="btn btn-success" style="padding-left:2%;padding-right:2%;margin-left:5%;">
