...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<nav  class="navbar navbar1 bg-dark" style="float:left;margin:0px;display:block;padding:0px;box-shadow:.2px 1px 2px 1px;" id="sh_menu">
			...
			<ul class="navbar-nav" style="width:100%;">
				...
				<li class="nav-item">
					<a class="btn btn-dark btn1" onclick="comp()" href="#">Manage SUBMISSIONS</a>
				</li>
				<li class="nav-item"  id="p_comp" style="display:none;border-top:1.2px solid white;">
					<a class="btn btn-dark btn1" onclick="pending()" href="#">Pending <br />Submissions<p id="specialchk"><?php echo $pend;?></p></a>
				</li>
				<li class="nav-item" id="i_comp"  style="display:none"> 
					<a class="btn btn-dark btn1" onclick="inpro()"  href="#">processing <p id="specialchk"><?php echo $inpro;?></p></a>
				</li>
				<li class="nav-item" id="ccomp" style="display:none;">
					<a class="btn btn-dark btn1" onclick="complcomp()"href="#">Complete <br />Submissions<p id="specialchk"><?php echo $compl; ?></p></a>
				</li>
				<li class="nav-item" id="f_comp" style="display:none;">
					<a class="btn btn-dark btn1" onclick="full()"  href="#">Full Submission<br /> history<p id="specialchk"><?php echo $full;?></p></a>
				</li>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<h4>>Dashboard<hr /></h4>
				<div id="file1" onclick="pending()" style="cursor:pointer;">
					...
					<p id="file12" style="display:block;font-size:15px;text-align:center;">Pending Submissions<div id="pen"><?php echo $pend; ?></div></p>
				</div>
					<div id="file2">
						<i class="fa fa-file-text" style="cursor:pointer;" onclick="inpro()"></i>
						<p id="file22" style="display:block;font-size:15px;text-align:center;"> processing submissions<div id="pen2"><?php echo $inpro; ?></div></p>
					</div>
						<div id="file3">
							<i class="fa fa-file-text" style="cursor:pointer;" onclick="complcomp()"></i>
							<p id="file32" style="display:block;font-size:15px;text-align:center;">Completed submissions<div id="pen3"><?php echo $compl; ?></div></p>
						</div>
			</div>
			...
			<h4>Porcessing Submissions<hr /></h4>
			<?php
				$num=0;
				$query1="SELECT * FROM `complaints`";
			...
			<h3>>Full history of Submissions<hr /></h3>
				<h4>>Pending Submissions<hr /></h4>
				<?php
					$query1="SELECT * FROM `complaints`";
					$result=mysqli_query($conn,$query1);
